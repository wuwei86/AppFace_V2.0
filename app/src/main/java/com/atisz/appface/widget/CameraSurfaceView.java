...
import com.atisz.appface.widget.CameraFrameData;
...
//                    mGLSurfaceView.setAspectRatio(mWidth, mHeight);
                    ...
                    mImageDataBuffers.offer(new com.atisz.appface.widget.CameraFrameData(mWidth, mHeight, mFormat, lineBytes * mHeight));
                    mImageDataBuffers.offer(new com.atisz.appface.widget.CameraFrameData(mWidth, mHeight, mFormat, lineBytes * mHeight));
                    mImageDataBuffers.offer(new com.atisz.appface.widget.CameraFrameData(mWidth, mHeight, mFormat, lineBytes * mHeight));
                }
