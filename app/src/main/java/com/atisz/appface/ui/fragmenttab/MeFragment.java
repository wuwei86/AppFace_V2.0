...
public class MeFragment extends MyBaseFragment {
    ...
    private void initTitle(){
        ...
        mMeTitle.setTitle("我的");
        mMeTitle.addRightImageButton(R.mipmap.icon_topbar_overflow, R.id.topbar_right_about_button)
        ...
        mMeTitle.addLeftImageButton(R.mipmap.ic_sideslip, R.id.topbar_left_Sideslip_button)
                .setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
